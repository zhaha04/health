...
public class CheckGroupServiceImpl implements CheckGroupService {
    ...
    public void update(CheckGroup checkGroup, Integer[] checkitemIds) {
        ...
        //判断商品是否被关联
        this.isCheckGroupByGoods(checkGroup.getId().toString());
    ...
    public void deleteById(int id) {
        ...
        // 判断商品是否被关联
        this.isCheckGroupByGoods(String.valueOf(id));
     ...
     */
    @Override
    public Set<String> findAllByCheckegroupToIds() {
        return checkGroupDao.findAllByCheckegroupToIds();
    }
     ...
     * 判断商品是否被关联
     */
    private void isCheckGroupByGoods(String strid) {
        Jedis jedis = jedisPool.getResource();
        // 查看是否被关联，没有被关联则可以修改
        String id = jedis.hget("checkgroup_id", strid);
        if (id != null) {
            jedis.close();
            // 如果被关联，不能被修改，抛商品在售异常
